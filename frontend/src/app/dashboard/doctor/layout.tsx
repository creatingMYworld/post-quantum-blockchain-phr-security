...
import { Bell, Calendar, ChevronLeft, FileText, Film, FlaskConical, KeyRound, LayoutDashboard, LogOut, Menu, ShieldCheck, User, Users, X } from "lucide-react";
...
const navItems = [
  ...
  { label: "Imaging", icon: Film, href: "/dashboard/doctor/imaging" },
        ...
        <Link href="/dashboard/doctor" className="flex items-center gap-3">
          ...
          {!collapsed && (
            ...
            >
              ...
              <span className="text-[10px] font-bold tracking-widest text-cyan-400/70 uppercase">Doctor Portal</span>
            </motion.div>
          )}
        </Link>
      </div>
        ...
        <header className="sticky top-0 z-20 bg-white/80 backdrop-blur-xl border-b border-slate-200/60 px-4 sm:px-8 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-lg sm:text-xl font-extrabold text-slate-800">Doctor Dashboard</h1>
