  ...
  return (
    <>
      ...
      <main className="flex-1 flex flex-col items-center justify-center pt-32 pb-20 px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="absolute inset-0 z-[-1] bg-[linear-gradient(to_right,#0000000a_1px,transparent_1px),linear-gradient(to_bottom,#0000000a_1px,transparent_1px)] bg-[size:24px_24px] [mask-image:radial-gradient(ellipse_60%_50%_at_50%_0%,#000_70%,transparent_100%)]" />
        ...
        <motion.div 
          ...
          animate="show"
        >
          <motion.div variants={item} className="inline-flex items-center gap-2 px-3 py-1 rounded-full border border-sky-500/30 bg-sky-100 text-sky-600 text-sm font-medium mb-8">
          ...
          <motion.h1 variants={item} className="text-5xl md:text-7xl font-extrabold tracking-tight mb-8">
            <span className="block text-slate-900">Immutable Health Data.</span>
            <span className="block text-transparent bg-clip-text bg-gradient-to-r from-sky-400 via-indigo-400 to-purple-500 pb-2">
              Quantum Secure.
            </span>
          </motion.h1>
          
          <motion.p variants={item} className="mt-4 text-xl text-slate-600 max-w-3xl mx-auto mb-10 leading-relaxed">
          ...
          <motion.div variants={item} className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <Link href="/login" className="px-8 py-4 bg-white text-black font-semibold rounded-lg hover:bg-gray-200 transition-colors w-full sm:w-auto text-center shadow-xl">
              Access Patient Portal
            </Link>
            <Link href="#" className="px-8 py-4 bg-transparent border border-white/20 text-slate-900 font-semibold rounded-lg hover:bg-slate-100 transition-colors w-full sm:w-auto text-center relative overflow-hidden group">
        ...
        >
          {[
            ...
            >
              ...
              <div className="w-12 h-12 rounded-lg bg-sky-100 flex items-center justify-center mb-6 text-sky-600 group-hover:scale-110 transition-transform">
